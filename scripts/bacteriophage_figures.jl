...
let 
    data001 = brconstrained_stabilitytracking(0.00001:0.0001:0.004, 0.1, -0.002, 0.1, 10000.0)
    data1 = brconstrained_stabilitytracking(0.00001:0.0001:0.004, 1, -0.002, 0.1, 10000.0)
    data10 = brconstrained_stabilitytracking(0.00001:0.0001:0.004, 10, -0.002, 0.1, 10000.0)
    ...
    ylabel("CV of optimum differences", fontsize = 15)
